...
namespace BinaryTree
{
  ...
  template <typename T>
  constexpr T null() { return std::numeric_limits<T>::max(); }
  ...
  public:
    ...
    explicit BinaryTreeNode(T item, BinaryTreeNode *left, BinaryTreeNode *right) : val(item), left(left), right(right){};
  ...
  public:
    ...
    display_rows get_row_display() const
    {
      ...
      // Use rows of BinaryTreeNode pointers to populate rows of cell_display structs.
      // All possible slots in the tree get a cell_display struct,
      // so if there is no actual BinaryTreeNode at a struct's location,
      // its boolean "present" field is set to false.
      // The struct also contains a string representation of
      // its BinaryTreeNode's value, created using a std::stringstream object.
    ...
    vector<string> row_formatter(const display_rows &rows_disp) const
    {
      ...
      // Reverse the result, placing the root BinaryTreeNode at the beginning (top)
